...
import org.dalhousie.trie.store.IntegerArrayListFactory;
import org.dalhousie.trie.store.IntegerList;
import org.dalhousie.trie.store.IntegerListFactory;
...
public class DoubleArrayTrieImpl extends AbstractDoubleArrayTrie {
	...
	/**
	 * @see AbstractDoubleArrayTrie#nextAvailableHop(int)
	 */
	@Override
	...
	/** 
	 * @see AbstractDoubleArrayTrie#nextAvailableMove(java.util.SortedSet)
	 */
	@Override
	...
	/**
	 * @see AbstractDoubleArrayTrie#getBase(int)
	 */
	@Override
	...
	/**
	 * @see AbstractDoubleArrayTrie#getCheck(int)
	 */
	@Override
	...
	/**
	 * @see AbstractDoubleArrayTrie#setBase(int, int)
	 */
	@Override
	...
	/**
	 * @see AbstractDoubleArrayTrie#setCheck(int, int)
	 */
	@Override
	...
	/**
	 * @see AbstractDoubleArrayTrie#getSize()
	 */
	@Override
	...
	/**
	 * @see AbstractDoubleArrayTrie#updateSearch(int, int, IntegerList)
	 */
	@Override
	...
	/**
	 * @see AbstractDoubleArrayTrie#updateInsert(int, int, IntegerList)
	 */
	@Override
	...
	/**
	 * @see AbstractDoubleArrayTrie#updateChildMove(int, int, int)
	 */
	@Override
	...
	/**
	 * @see AbstractDoubleArrayTrie#updateStateMove(int, int)
	 */
	@Override
